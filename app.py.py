...
st.image('https://www.homesoverseas.ru/upload/userfiles/images/bulgaria1.jpg')
...
place = st.empty() 
place.image('https://i.pinimg.com/originals/71/3a/32/713a3272124cc57ba9e9fb7f59e9ab3b.gif', width = 85 )
if price > 0: 
    for i in range(100):
        time.sleep(0.05)
